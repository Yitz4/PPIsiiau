package com.udg.demo.controller;

import com.udg.demo.models.StudentModel;
import com.udg.demo.services.StudentService;
...
public class StudentController {
    ...
    public Optional<StudentModel> finStudentByCode(@PathVariable String code){
        return service.findStudentByCode(code);
    }

    @GetMapping("/findStudentByName/{name}")
    public Optional<StudentModel> finStudentByName(@PathVariable String name){
